							...
							return <ListItem key={i}
								...
								<div className="flex h-full p-3">
									...
									<div className="shrink-0">
										{"price" in object ? formatMoney(object?.price ?? 1) : ""}
									</div>
			...
			<div className={commonStyles.management.splitScreen.details.container}>
				{
					getSelectedObject() !== undefined
						...
						: <h2 className={tw(commonStyles.management.title, "text-center")}>Select a{"AEIOU".includes(selectedType.type[0].toUpperCase()) ? "n" : ""} {selectedType.type} from the list</h2>
				}
			</div>
		</div>
	</div>
